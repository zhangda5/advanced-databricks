...
# MAGIC %pip install --quiet --disable-pip-version-check https://github.com/databricks-academy/advanced-data-engineering-test-data-example/releases/download/v0.0.5/data_setup-0.0.5-py3-none-any.whl
